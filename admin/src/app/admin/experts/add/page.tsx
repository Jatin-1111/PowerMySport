            ...
            <div className="mb-6 grid gap-5 sm:grid-cols-2">
              ...
              {showAddressField && (
                <div className="flex flex-col gap-1.5 sm:col-span-2">
                  <label className="text-sm font-medium text-slate-700">In-person location</label>
                  <input
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <ExpertiseMultiSelect value={field.value || []} onChange={field.onChange} />
                  )}
                />
              </div>
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mb-5 text-xs leading-relaxed text-slate-500">
              Set the expert's weekly hours so clients can book right away. Leave this blank to let
              them set it themselves later.
            </p>
