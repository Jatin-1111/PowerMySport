...
const WA_MESSAGE =
  "Hi! I found PowerMySport and would like to know more about sports guidance for my child.";
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 select-none">
      ...
      <div className="flex items-center gap-2">
        <motion.a
          ...
          aria-label="Chat with PowerMySport on WhatsApp"
          ...
          whileTap={{ scale: 0.91 }}
          className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-green-500/30"
        >
