...
import { PresignedUrl } from "@/types/onboarding";
import { uploadFileToPresignedUrl } from "@/lib/onboarding";
...
const DOCUMENT_REQUIREMENTS: Record<string, string> = {
  OWNERSHIP_PROOF: "Proof of Ownership (Deed/Title Document)",
  BUSINESS_REGISTRATION: "Business Registration Certificate",
  TAX_DOCUMENT: "Tax Return or GST Certificate",
  INSURANCE: "Business/Liability Insurance Policy",
  CERTIFICATE: "Safety or Fire Department Certificate",
};
      ...
      <div className="mb-8">
        ...
        <div className="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded">
          <p className="text-sm text-yellow-800">
            ⚠️ Please upload all required documents for verification. Each file
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="p-4 bg-blue-50 border border-blue-200 rounded">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>✓ Your venue will be reviewed by our admin team</li>
            <li>
              ✓ You'll receive an email once approved or if we need more
              information
            </li>
            <li>✓ Approved venues can start accepting bookings immediately</li>
          </ul>
        </div>
        ...
        >
          {loading ? "Finalizing Onboarding..." : "✓ Complete Onboarding"}
        </button>
