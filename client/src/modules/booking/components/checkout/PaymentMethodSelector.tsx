        ...
        return (
          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-2">
              {option.badge && (
                <span className="bg-turf-green/10 text-turf-green rounded-full px-2.5 py-0.5 text-xs font-semibold">
                  {option.badge}
                </span>
              )}
              <span
                className={cn(
                  ...
                  isSelected ? "border-power-orange bg-power-orange" : "border-slate-300 bg-white"
                )}
              >
