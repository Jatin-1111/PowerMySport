...
// that route file under the src/app size ratchet (tests/oversizedFiles.json:
// "src/app is for routing and composition: move the logic into
// src/modules/<feature>/ and keep the route as a shell").
