...
import { isExternalReturnPath, postLoginFor, safeReturnPath } from "@/flow/policy";
...
function LoginContent() {
  ...
  const redirectTo = safeReturnPath(searchParams.get("redirect") || searchParams.get("next"));
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-power-orange text-xs font-semibold transition-colors hover:text-orange-600"
              >
                Forgot password?
              </Link>
            </div>
