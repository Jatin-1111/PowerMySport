...
export const metadata = {
  ...
  description: "Manage your academy onboarding and public presence on PowerMySport",
};
      ...
      <section className="rounded-3xl border border-white/70 bg-[linear-gradient(135deg,#0f172a_0%,#1e293b_55%,#fff4e5_100%)] px-6 py-8 text-white shadow-xl sm:px-8 sm:py-10">
        <div className="max-w-3xl space-y-4">
          ...
          <p className="max-w-2xl text-sm text-white/80 sm:text-base">
            Complete onboarding, track approval, and keep your academy profile ready for players,
            parents, and coaches.
          </p>
