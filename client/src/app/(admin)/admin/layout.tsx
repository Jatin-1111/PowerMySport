    ...
    <div className="flex h-screen bg-slate-50">
      ...
      <aside className="sticky top-0 h-screen w-64 bg-slate-900 shadow-xl flex flex-col relative">
        ...
        <div className="p-6 mt-auto border-t border-slate-700">
          <Link
            href="/"
            className="flex items-center justify-center gap-2 w-full text-center px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-colors"
          >
