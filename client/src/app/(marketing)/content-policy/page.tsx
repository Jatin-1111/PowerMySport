          ...
          <Card className="legal-content prose prose-lg max-w-none bg-white p-8 lg:col-start-2">
            ...
            <section className="mt-12 border-t border-gray-300 pt-8">
              <p className="text-sm text-gray-600">
                This Content Policy may be updated at any time. Continued use of PowerMySport means
                you accept the current policy. Major changes will be communicated 30 days in
                advance.
              </p>
            </section>
          </Card>
