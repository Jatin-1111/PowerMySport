      ...
      <div className="container mx-auto max-w-4xl px-4 py-16 md:py-24">
        <article className="prose prose-lg max-w-none">
          ...
          <p className="mb-8 text-sm text-gray-600">
            <strong>Last Updated:</strong> February 18, 2026 | <strong>Effective Date:</strong>{" "}
            February 18, 2026
          </p>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              anonymous, aggregated usage analytics (such as which pages are opened) using a random
              visitor id that contains no personal information. When you first visit, we show a
              brief notice so you can acknowledge this policy. This Cookie Policy explains how we
              use cookies and your choices regarding them.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Cookies help us recognize you, remember your preferences, and improve your user
              experience.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                <strong>Local Storage:</strong> Stores data locally on your device (not sent to
                servers unless retrieved)
              </li>
              <li>
                <strong>Session Storage:</strong> Clears when you close the browser
              </li>
              <li>
                <strong>Web Beacons/Pixels:</strong> Transparent 1x1 images used to measure
                engagement
              </li>
            </ul>
            <p className="mt-3">
              You can clear local storage through your browser settings or by clearing your browsing
              data.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              store information directly but communicate with our servers to count page visits.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              indicates when the policy was last modified. Continued use of our website after
          ...
          <section className="mt-12 border-t border-gray-300 pt-8">
            <p className="text-sm text-gray-600">
              This Cookie Policy is a formal document binding both PowerMySport and its users. By
              using our website, you acknowledge receipt and understanding of this policy.
            </p>
          </section>
        </article>
      </div>
