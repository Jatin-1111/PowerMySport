...
import {
  ...
  formatFullDate,
  formatShortDate,
} from "@/modules/pathway/services/tournamentEditionPage";
 ...
 *
 * fetchEdition / formatFullDate / formatShortDate / DOCUMENT_META live in
 * modules/pathway/services/tournamentEditionPage.ts — moved out, not
 * rewritten, to keep this route file under the src/app size ratchet.
 */
