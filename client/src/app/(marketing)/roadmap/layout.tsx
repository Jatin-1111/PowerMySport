...
export const metadata: Metadata = {
  ...
  description:
    "Stage-by-stage sports pathways for Indian parents. Where your child is now, what to look for, the decisions ahead, and what to do next, all written with coaches and experienced parents. Free to read.",
  alternates: {
    canonical: "/roadmap",
  },
  openGraph: {
