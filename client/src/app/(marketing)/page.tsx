          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 280, damping: 20 }}
                className="group relative flex flex-col rounded-2xl border-2 border-power-orange/60 bg-orange-50/50 p-8 backdrop-blur-md shadow-[0_8px_40px_-8px_rgba(233,115,22,0.25)] will-change-transform scale-100 md:scale-105"
              >
