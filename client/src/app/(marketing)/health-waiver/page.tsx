    ...
    <main className="min-h-screen bg-white">
      <div className="container mx-auto max-w-4xl px-4 py-16 md:py-24">
        <article className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="mb-4 mt-8 text-2xl font-semibold">2. Assumption of Risk</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="mb-4 mt-8 text-2xl font-semibold">3. Health Declaration</h2>

            <h3 className="mb-3 mt-6 text-xl font-semibold">3.1 Medical Fitness Confirmation</h3>
            ...
            <h3 className="mb-3 mt-6 text-xl font-semibold">3.2 Disclosure Obligation</h3>
            ...
            <h3 className="mb-3 mt-6 text-xl font-semibold">3.3 Liability for Non-Disclosure</h3>
            <p>
          ...
          <section className="mb-8">
            <h2 className="mb-4 mt-8 text-2xl font-semibold">4. Release & Waiver of Liability</h2>

            <h3 className="mb-3 mt-6 text-xl font-semibold">4.1 Comprehensive Release</h3>
            ...
            <h3 className="mb-3 mt-6 text-xl font-semibold">4.2 Scope of Release</h3>
            ...
            <h3 className="mb-3 mt-6 text-xl font-semibold">4.3 Exceptions to Waiver</h3>
          ...
          <section className="mb-8">
            ...
            <h3 className="mb-3 mt-6 text-xl font-semibold">5.1 Your Insurance Responsibility</h3>
            <p>
              <strong>
            ...
            <h3 className="mb-3 mt-6 text-xl font-semibold">5.2 Facility & Coach Insurance</h3>
            ...
            <h3 className="mb-3 mt-6 text-xl font-semibold">5.3 Emergency Medical Response</h3>
          ...
          <section className="mb-8">
            <h2 className="mb-4 mt-8 text-2xl font-semibold">8. Parental Consent for Minors</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 mt-8 text-2xl font-semibold">11. Continued Participation</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="mb-4 mt-8 text-2xl font-semibold">12. Contact & Questions</h2>
