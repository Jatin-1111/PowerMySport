    ...
    <main className="min-h-screen bg-white">
      <div className="container mx-auto max-w-4xl px-4 py-16 md:py-24">
        <article className="prose prose-lg max-w-none">
          <h1 className="mb-4 text-4xl font-bold">Parental Consent & Minor Protection Policy</h1>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              requirements and protections for parents, guardians, and minors participating in
              sporting activities through our marketplace.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>Be the legal parent or court-appointed guardian of the minor</li>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>Proof of guardianship (birth certificate, adoption papers, court order)</li>
              <li>Address verification</li>
              <li>Contact information (phone, email)</li>
            </ul>
            <p className="mt-3">
              <strong>Note:</strong> We reserve the right to suspend accounts if guardianship cannot
              be verified.
            </p>
          ...
          <section className="mb-8">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                Read and accept the Health, Safety &amp; Liability Waiver (see separate document) on
                behalf of the minor
              </li>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                Assume full liability for any injuries, damages, or claims arising from the minor's
                participation
              </li>
              <li>Release PowerMySport, coaches, and facilities from all liability</li>
              <li>
                Agree to indemnify (reimburse) them for any damages the minor causes to others
              </li>
              <li>Accept responsibility for all medical costs if insurance does not cover them</li>
            ...
            <p>
              ...
              in effect. You may withdraw your consent at any time by contacting us or removing the
              dependent&apos;s profile; withdrawal takes effect for future bookings only and does
              not affect activities already completed.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              The Platform does not currently collect or store structured medical or health
              information about your dependent (such as chronic conditions, medications, allergies,
              or immunization records). You are solely responsible for directly informing the coach
              or venue staff, in person or via your own communication channel, of any health
              condition, allergy, medication, or physical limitation relevant to your
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                For children with pre-existing conditions, you should consult with their
                pediatrician before booking activities
              </li>
              <li>Coaches are not medical professionals and cannot provide medical advice</li>
              <li>
            ...
            <p>
              ...
              to reach you. PowerMySport does not maintain a separate physician, dentist, or
              insurance record for your dependent; keeping that information accessible to yourself
              and sharing it directly with venue/coach staff when relevant is your responsibility.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                <strong>Under 8 years:</strong> Adult supervision (parent or designated guardian) is
                mandatory at the facility
              </li>
              <li>
                <strong>8-12 years:</strong> An adult should be present or on-call at the facility
              </li>
              <li>
                <strong>13-17 years:</strong> May attend without direct parental supervision (but
                parent responsible for drop-off/pick-up)
              </li>
            </ul>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>Provide their full name, relationship, and contact information</li>
              <li>They must be at least 18 years old</li>
              <li>They must be authorized to make emergency decisions if needed</li>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>Arranging alternative pick-up if you cannot collect your child</li>
              <li>Informing the facility of any changes in pick-up arrangements</li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p>
              Activities such as advanced training, competitive sports, or high-intensity fitness
              may have age restrictions. You must:
            </p>
            <ul className="mt-3 list-disc space-y-2 pl-6">
          ...
          <section className="mb-8">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>Accepting liability if your child damages property or harms others</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mt-3">
              As noted in Section 5, we do not collect structured medical or health data about your
              dependent.
            </p>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>
                Not selling data to third parties, and sharing it only as described in our Privacy
                Policy (e.g. with the venue/coach for a confirmed booking, or as required by law)
              </li>
              <li>
                Not using a dependent&apos;s data for marketing, advertising, or behavioural
                tracking
              </li>
              <li>
                Aligning our practices with the Digital Personal Data Protection Act, 2023 (India)
                as it comes into force in phases, and with the Information Technology Act, 2000 and
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>
                Request deletion of a child&apos;s profile and data (via the &quot;Remove
                Profile&quot; action described in Section 11, or by contacting us)
              </li>
              <li>Withdraw consent at any time; this takes effect for future bookings only</li>
              <li>
                Request a copy of the personal data we hold about their child, which we will provide
          ...
          <section className="mb-8">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              ...
              <li>Recordings are used for facility management and dispute resolution</li>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              converted to an independent account (which they will then control themselves using
              their own credentials); until that happens, the profile remains linked to your account
          ...
          <section className="mt-12 rounded-lg border-t border-gray-300 bg-blue-50 p-4 pt-8">
            <p className="inline-flex items-start gap-2 text-sm font-bold text-blue-900">
              <ShieldAlert className="mt-0.5 h-4 w-4 shrink-0" />
              <span>
                If you suspect abuse, exploitation, or harm to a minor, please contact us
                immediately at teams@powermysport.com or your local law enforcement.
              </span>
            </p>
          </section>
        </article>
