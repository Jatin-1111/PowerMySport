          ...
          <Card className="legal-content bg-white p-8 prose prose-slate max-w-none lg:col-start-2">
            <section id="agreement" className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                ...
                Cancellation, Refund &amp; Dispute Policy, which are
            ...
            <section id="services" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2">
                ...
                <li>
                  ...
                  training programs, subscription plans, and packages to players
                </li>
                <li>
              ...
              <p className="text-slate-600 leading-relaxed mt-4">
                ...
                responsible for all activity conducted through dependent
              ...
              <p className="text-slate-600 leading-relaxed mt-4">
                ...
                we expressly disclaim any responsibility for the acts,
                omissions, or conduct of any third party. We reserve the right
                to modify, suspend, restrict, or discontinue any feature of the
                Platform, in whole or in part, at any time and without liability
                or notice.
              </p>
            </section>
            ...
            <section id="account" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2">
                ...
                <li>
                  Not register on behalf of, or impersonate, any third party
                </li>
                <li>
            ...
            <section id="fraud-prevention" className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                PowerMySport that asks for any of this information, do not share
                it — report it immediately to teams@powermysport.com. We are not
                liable for any loss you incur by sharing your password, OTP,
                CVV, or other account credentials with any third party,
            ...
            <section id="responsibilities" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-6">
                <li>
                  Comply strictly with all applicable laws and regulations
                </li>
                ...
                <li>
                  Maintain accurate and truthful profile information at all
                  times
                </li>
                <li>
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-6">
                <li>
                  Provide accurate, current venue information and photographs
                </li>
                <li>
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-6">
                ...
                <li>
                  Honor every confirmed coaching session without exception
                </li>
                <li>
              ...
              <div className="bg-orange-50 border-l-4 border-power-orange p-4 mb-5 rounded-r-lg not-prose">
                <p className="text-slate-700 text-sm font-medium">
                  ...
                  Expert. Experts are independently contracted service
                  providers, not employees of PowerMySport.
                </p>
              </div>
              <ul className="list-disc pl-6 text-slate-600 space-y-3">
                <li>
                  <strong>Accurate profile:</strong> Maintain a truthful,
                  current, and complete profile at all times, including bio,
                  sports, expertise areas, achievements, qualifications, session
                  fee, session mode (online / in-person / both), session
                  duration, languages, city, and weekly availability schedule.
                  Misleading profile information is grounds for immediate
                  suspension
                </li>
                <li>
                  <strong>Credentials:</strong> Provide only verifiable,
                  authentic credentials, qualifications, and achievement claims.
                  Furnish documentary proof upon request by PowerMySport or,
                  where required, to clients. Misrepresentation of credentials
                ...
                <li>
                  ...
                  guidance, mentorship, or advisory services represented in your
                  profile. Sessions must be lawful, respectful, and appropriate
                  at all times
                </li>
                <li>
                ...
                <li>
                  ...
                  immediately terminate your account and recover unpaid
                  commission
                </li>
                <li>
                ...
                <li>
                  <strong>Tax compliance:</strong> You are solely responsible
                  for reporting and remitting all taxes (including GST, income
                  tax, and TDS, as applicable) on income earned through the
                  Platform. PowerMySport may deduct TDS as required by
                  applicable Indian law and will issue the relevant statutory
                  certificate
                </li>
                <li>
                  ...
                  responsibility for any injury, loss, or damage occurring
                  during or arising from any session you conduct
                </li>
                <li>
            ...
            <section id="expert-verification" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-6">
                ...
                <li>
                  ...
                  and is under review by the PowerMySport team. We aim to
                  complete the review within 5–7 business days, though this may
                  take longer. You will be notified of the outcome via email and
                ...
                <li>
                  ...
                  misrepresentation during verification may result in a
                  permanent ban from the Expert programme
                </li>
              </ul>
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-6">
                ...
                <li>
                  ...
                  or credential verification through third-party services at any
                  time, including after initial approval
                </li>
                <li>
                ...
                <li>
                  ...
                  flow but remain subject to all Expert obligations in these
                  Terms
                </li>
              </ul>
            ...
            <section id="booking" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-6">
                <li>
                  All bookings are subject to availability and are not
                ...
                <li>
                  ...
                  split applies only to what players owe each other and does not
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                capacity, or behavioral concerns, or any other good-faith reason
                not prohibited by applicable law. Where a confirmed booking is
                declined at the point of service for such a reason, refund
                treatment is governed by our Cancellation, Refund &amp; Dispute
                Policy in the same way as any other provider-initiated
            ...
            <section id="ranking" className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                When you search for or browse venues, coaches, or experts on the
                Platform, the order in which listings appear is determined by
                factors that include: verification or approval status (only
            ...
            <section id="commission" className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                PowerMySport reserves the right to charge venue listers,
                coaches, and experts a commission on successful bookings and
                completed sessions:
              </p>
              <ul className="list-disc pl-6 text-slate-600 space-y-2">
                <li>
                  For Experts and Academies, the platform commission is 15% of
                  the listed fee on every completed transaction, plus GST on the
                  commission. This and the full onboarding terms for these
                  partners are set out in our{" "}
                  <a
                    href="/partner-terms"
            ...
            <section id="feedback" className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                similar; and (c) we may use, modify, and implement your Feedback
                for any purpose, without payment or attribution to you, and you
                waive any claim that a feature we build or ship is based on your
                Feedback.
              </p>
            </section>
            ...
            <section id="liability" className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                ...
                INCLUDES, WITHOUT LIMITATION, ANY CLAIM ARISING FROM THE
                QUALITY, ACCURACY, OR OUTCOME OF ADVICE OR GUIDANCE PROVIDED BY
                AN EXPERT DURING A SESSION.
              </p>
              <p className="text-slate-600 leading-relaxed">
            ...
            <section id="indemnification" className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                any content, listing, or information you submit; (e) any
                dispute, injury, or damage arising between you and another user;
                or (f) for Experts specifically, any advice, guidance, or
                service provided during a session and any claim by a client
                arising therefrom, including any claim based on the
                Expert&apos;s credentials, representations, or conduct. This
                obligation survives termination of your account or these Terms.
              </p>
            </section>
            ...
            <section id="dispute" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2">
                <li>
                  You must first raise the issue with our support team in
                  writing and allow thirty (30) days for resolution before
                ...
                <li>
                  ...
                  right you have to file a complaint jointly with other
                  consumers under Section 35 of the Consumer Protection Act,
                  2019
                </li>
              </ul>
              <p className="text-slate-600 leading-relaxed mt-4">
                ...
                &quot;consumer&quot; to approach the appropriate District,
                State, or National Consumer Disputes Redressal Commission under
                the Consumer Protection Act, 2019, to the extent such right
                cannot be excluded by agreement under applicable Indian law.
              </p>
            </section>
            ...
            <section id="termination" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-4">
                ...
                <li>
                  For Experts specifically: misrepresentation during
                  verification, repeated session cancellations or no-shows,
                  soliciting reviews or payments outside the Platform, breach of
                  client confidentiality, or failure to maintain a valid payout
                  method
                </li>
              ...
              <p className="text-slate-600 leading-relaxed mt-4">
                ...
                explaining why the action should be reversed. We will review the
                request and respond within a reasonable time. Requesting
            ...
            <section id="general" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-2">
                ...
                <li>
                  ...
                  or it is permanently barred, regardless of any longer
                  statutory limitation period that would otherwise apply, except
                  where such a time limit cannot lawfully be shortened under
            ...
            <section id="governing-law" className="mb-8">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                Rules, 2020, the Information Technology Act, 2000 and rules made
                thereunder, and the Digital Personal Data Protection Act, 2023,
                each as in force and applicable from time to time.
              </p>
            </section>
