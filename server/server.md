...
- **Raw Body parsing**: The PhonePe webhook route is registered _before_ the global JSON parser to capture raw buffers for webhook signature validation. Adding middleware above it could break payments.
