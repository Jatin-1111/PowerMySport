 ...
 * is stored here.
 */
export const trackGuestEvents = asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
export const getGuestActivity = asyncHandler(async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const clearAnalyticsData = asyncHandler(
