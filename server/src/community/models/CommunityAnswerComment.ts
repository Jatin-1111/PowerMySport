 ...
 */
const communityAnswerCommentSchema = new Schema<CommunityAnswerCommentDocument>(
  {
    answerId: {
...
export const CommunityAnswerComment = mongoose.model<CommunityAnswerCommentDocument>(
