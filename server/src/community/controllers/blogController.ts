...
// ─── Comments ───────────────────────────────────────────────────────────────
export const listBlogComments = async (req: Request, res: Response): Promise<void> => {
  try {
    const page = Number(req.query.page) || 1;
...
export const createBlogComment = async (req: Request, res: Response): Promise<void> => {
  try {
...
// ─── Profiles ───────────────────────────────────────────────────────────────
export const getMyBlogProfile = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const getBlogAuthorProfile = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const updateBlogProfile = async (req: Request, res: Response): Promise<void> => {
  try {
...
// ─── Image upload ─────────────────────────────────────────────────────────
export const getBlogImageUploadUrl = async (req: Request, res: Response): Promise<void> => {
  try {
