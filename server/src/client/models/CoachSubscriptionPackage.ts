...
const coachSubscriptionPackageSchema = new Schema<CoachSubscriptionPackageDocument>(
  {
    coachId: {
...
coachSubscriptionPackageSchema.virtual("id").get(function (this: CoachSubscriptionPackageDocument) {
...
export const CoachSubscriptionPackage = mongoose.model<CoachSubscriptionPackageDocument>(
