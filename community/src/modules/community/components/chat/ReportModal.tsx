    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            onClick={onClose}
            className="border-border rounded-lg border p-1.5 text-slate-500 transition hover:bg-slate-100"
          >
            <X size={16} />
          </button>
        </div>
        <div className="mt-4 space-y-3">
          <div>
            ...
            <select
              ...
              className="border-border bg-background focus:border-power-orange w-full rounded-lg border px-3 py-2 text-sm focus:outline-none"
            >
        ...
        <div className="mt-4 flex gap-3">
          <button
            onClick={onClose}
            className="border-border flex-1 rounded-lg border bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50"
          >
            Cancel
          </button>
          <button
