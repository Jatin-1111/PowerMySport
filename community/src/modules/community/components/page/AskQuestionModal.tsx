              ...
              >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full appearance-none rounded-2xl border border-slate-200 bg-white/80 px-4 py-3 pr-10 text-sm shadow-sm transition focus:border-violet-500/50 focus:outline-none focus:ring-4 focus:ring-violet-500/10"
                        >
                    ...
                    <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50/60 px-4 py-3">
                      <div className="relative">
                        ...
                        />
                        <div
                          className={`h-5 w-9 rounded-full transition-colors ${isAnonymous ? "bg-slate-700" : "bg-slate-300"}`}
                        />
                        <div
                          className={`absolute top-0.5 h-4 w-4 rounded-full bg-white shadow transition-transform ${isAnonymous ? "translate-x-4" : "translate-x-0.5"}`}
                        />
                      </div>
                ...
                <div className="flex shrink-0 items-center justify-end gap-3 rounded-b-[2rem] border-t border-slate-100 bg-slate-50/50 px-6 py-4 sm:px-8 sm:py-5">
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                    className="bg-power-orange-solid shadow-power-orange/20 focus:ring-power-orange/20 inline-flex min-w-[150px] items-center justify-center gap-2 rounded-2xl px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition hover:bg-[#d96610] focus:outline-none focus:ring-4 disabled:cursor-not-allowed disabled:opacity-70"
                  >
                    {isSubmitting ? (
                      <>
