          ...
          <div className="p-5">
            ...
            {searchQuery ? (
              ...
              <div className="flex flex-col items-center justify-center py-8 text-center">
                <div className="text-power-orange mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-orange-50">
                  {isGroup ? <Users size={24} /> : <MessageSquare size={24} />}
                </div>
                <p className="mb-2 text-[15px] font-semibold text-slate-700">
                  {isGroup ? "Find your community" : "Connect with parents"}
                </p>
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl bg-slate-900 px-6 py-2.5 text-sm font-semibold text-white shadow-md transition hover:bg-slate-800 active:scale-95"
                >
