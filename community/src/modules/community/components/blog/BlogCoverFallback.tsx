...
export default function BlogCoverFallback({
  ...
  return (
    ...
    >
      <div className="bg-power-orange/25 pointer-events-none absolute -top-8 -right-8 h-40 w-40 rounded-full blur-3xl" />
      ...
      <div className="relative flex flex-col items-center gap-2 text-center">
        ...
        <span className="text-[11px] font-semibold tracking-[0.28em] text-white/60 uppercase">
          {label}
        </span>
