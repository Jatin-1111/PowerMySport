...
export default function BlogCoverFallback({
  ...
  return (
    ...
    >
      <div className="bg-power-orange/25 pointer-events-none absolute -right-8 -top-8 h-40 w-40 rounded-full blur-3xl" />
      <div className="pointer-events-none absolute -bottom-10 -left-6 h-40 w-40 rounded-full bg-sky-400/20 blur-3xl" />
      <div className="bg-size-[26px_26px] pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)]" />
