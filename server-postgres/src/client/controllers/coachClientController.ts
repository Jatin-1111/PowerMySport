...
export const getCoachClientsHandler = async (
  ...
  try {
    ...
    res
      .status(200)
      .json({ success: true, message: "Clients retrieved", data: clients });
  } catch (error) {
    res
      .status(500)
      .json({
...
export const addClientNoteHandler = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
    ...
    res
      .status(201)
      .json({ success: true, message: "Note added", data: created });
  } catch (error) {
    res
      .status(400)
      .json({
...
export const deleteClientNoteHandler = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
